...
#ifndef CUCKOO_UTILS_H
#define CUCKOO_UTILS_H
...
extern ScanKeyData ForeignServerTableScanKey[LAST_CUCKOO_FOREIGN_SERVER_TABLE_SCANKEY_TYPE];
extern ScanKeyData DirectoryTableScanKey[LAST_CUCKOO_DIRECTORY_TABLE_SCANKEY_TYPE];
extern ScanKeyData InodeTableScanKey[LAST_CUCKOO_INODE_TABLE_SCANKEY_TYPE];
extern ScanKeyData
    InodeTableIndexParentIdPartIdNameScanKey[LAST_CUCKOO_INODE_TABLE_INDEX_PARENT_ID_PART_ID_NAME_SCANKEY_TYPE];
extern ScanKeyData XattrTableScanKey[LAST_CUCKOO_XATTR_TABLE_SCANKEY_TYPE];
...
typedef enum CUCKOO_LOCK_OPERATION { CUCKOO_LOCK_2PC_CLEANUP } CUCKOO_LOCK_OPERATION;

#define SET_LOCKTAG_CUCKOO_OPERATION(tag, operationId) \
