...
#ifndef CUCKOO_SHARD_TABLE_H
#define CUCKOO_SHARD_TABLE_H
...
typedef struct FormData_cuckoo_shard_table 
{
    int32_t range_point;
    int32_t server_id;
} FormData_cuckoo_shard_table;
typedef FormData_cuckoo_shard_table *Form_cuckoo_shard_table;

#define Natts_cuckoo_shard_table 2
#define Anum_cuckoo_shard_table_range_point 1
#define Anum_cuckoo_shard_table_server_id 2
