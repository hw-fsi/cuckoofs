...
class CuckooIOClient {
  public:
    ...
    CuckooIOClient(std::shared_ptr<brpc::Channel> initChannel)
    {
        channel = initChannel;
        stub = std::make_unique<cuckoo::brpc_io::RemoteIOService_Stub>(initChannel.get());
    }
  ...
  private:
    ...
    std::unique_ptr<cuckoo::brpc_io::RemoteIOService_Stub> stub;
};
